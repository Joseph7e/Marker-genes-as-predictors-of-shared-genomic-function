...
#
# uclustPipeline.py [] :
# Run UCLUST commands to generate an aligned fasta file containing
# clustered 16S sequences based upon a variable percent identity.
# Read the fasta file(result_aligned.fasta) and output each block that
...
for p in range(int(min_percent), 100):
	os.system("uclust --input " + sorted_fasta_file + "--uc " + fasta_file_id + " --id " + str(p))
